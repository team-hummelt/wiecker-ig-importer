<?php
namespace WiIg\SrvApi\Endpoint;
...
class Make_Remote_Exec
{
    ...
    private function make_json_config(): void
    {
    ...
    private function check_is_plugin_aktiv(): void
    {
    ...
    public function remove_wp_rss_importer_admin_page(): void
    {
        echo sprintf('<div class="notice notice-error is-dismissible"><p><b>%s</b> - %s %s</p></div>',__('WP Instagram Importer', 'wiecker-ig-importer') ,__('Plugin has been disabled.','wiecker-ig-importer'),__('Contact the support.' ,'wiecker-ig-importer'));
    }
